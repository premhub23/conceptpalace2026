...
$result = $conn->query("SELECT * FROM jonathan ORDER BY uploaded_at DESC LIMIT $start, $limit");
...
<h2 class="text-center mb-4">Jonathan Providence Image Gallery</h2>
<div class="row">
...
<a class="page-link" href="?page=<?php echo $i; ?>"></a>
</li>
<?php endfor; ?>
</ul>
</nav>
