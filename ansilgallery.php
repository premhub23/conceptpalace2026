...
$result = $conn->query("SELECT * FROM ansil ORDER BY uploaded_at DESC LIMIT $start, $limit");

if(!$result){
    die("Main Query Error: " . $conn->error);
}

$totalQuery = $conn->query("SELECT COUNT(*) as total FROM ansil");
...
<h2 class="text-center mb-4">Ansil Quow Image Gallery</h2>
<div class="row">
